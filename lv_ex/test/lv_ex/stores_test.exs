defmodule LvEx.StoresTest do
  ...
  describe "store" do
    ...
    import LvEx.StoresFixtures

    @invalid_attrs %{Hours: nil, city: nil, name: nil, open: nil, phone_number: nil, street: nil, zip: nil}
    ...
    test "create_store/1 with valid data creates a store" do
      valid_attrs = %{Hours: "some Hours", city: "some city", name: "some name", open: true, phone_number: "some phone_number", street: "some street", zip: "some zip"}
    ...
    test "update_store/2 with valid data updates the store" do
      store = store_fixture()
      update_attrs = %{Hours: "some updated Hours", city: "some updated city", name: "some updated name", open: false, phone_number: "some updated phone_number", street: "some updated street", zip: "some updated zip"}
